  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center ">
      <main>
        ...
        <div className="mt-10 flex text-white items-center gap-2">
        ...
        <form onSubmit={createPoll} className="mt-10 flex ">
          ...
          />
          <button
            className="px-6 py-4 rounded font-bold text-sm uppercase bg-yellow-500 text-gray-900 hover:bg-yellow-600"
            type="submit"
          >
            Criar meu bolão
          </button>
      ...
      <Image src={appPreviewImg} alt="Prévia APP móvel" quality={100} />
    </div>
  )
}
